...
ggplot(mydata, mapping = aes(y = study_load, x = social_support, color = stress_level)) + geom_point(position = "jitter") + geom_smooth(method = "lm") + labs(title = "Relationship Between Study Load, Social Support, and Stress Level" )
