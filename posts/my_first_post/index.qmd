...
graph_2 <- ggplot(mydata, mapping = aes(y = study_load, x = social_support, color = stress_level)) + geom_point(position = "jitter") + geom_smooth(method = "lm") + labs(title = "Study Load vs Social Support", x = "Social Support", y = "Study Load", color = "Stress Level" )
